...
!  Validate the parsed update selection and record its effective state.
!  Both actions are diagnostic-only unless strict pair checking is enabled.
      CALL APPLY_FIXED_ORBITAL_DAMPING(NW, LFIX, ODAMP)
      CALL CHECK_RELATIVISTIC_PAIRS
      CALL TRACE_ORBITAL_SELECTION
!
